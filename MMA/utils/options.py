...
def get_args():
    parser = argparse.ArgumentParser(description="MMA Args")
    ...
    parser.add_argument("--masked_token_rate", type=float, default=0.7, help="masked token rate for mlm task")
    ...
    ######################## MAE setting  ###################################
    parser.add_argument("--need_MAE", default=True, action='store_true',help="whether to use MAE")
    parser.add_argument("--mask_ratio", type=float, default=0.8, help="MAE image mask_ratio")
    ...
    parser.add_argument("--mae_loss_weight", type=float, default=1.0, help="mlm loss weight")
    
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='ndf', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm']")
    ...
    parser.add_argument("--root_dir", default="/home/zbh/xyh/data/CUHK-PEDES")
