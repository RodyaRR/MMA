...
config_file  = '/home/zbh/YangDSCH/double/logs/CUHK-PEDES/20250213_191749_baseline_ndf+mae_0.8_4/configs.yaml'
...
vq_feats, vg_feats, _, _ = evaluator._compute_embedding_tse(model.eval())
...
similarity=(sims_bge+sims_tse)/2

# acclerate sort with topk
_, indices = torch.topk(similarity, k=10, dim=1, largest=True, sorted=True)  # q * topk

dataset = CUHKPEDES(root='/home/zbh/xyh/data/CUHK-PEDES')
...
def plot_retrieval_images(query_id, image_ids, query_caption, image_paths, gt_img_path, fname='170.png'):
    print(query_id)
    print(image_ids)
    print(query_caption)
    fig = plt.figure()
...
query_id, image_ids, query_caption, image_paths, gt_img_path = get_one_query_caption_and_result_by_id(170, indices, qids, gids, captions, img_paths, gt_img_paths)
